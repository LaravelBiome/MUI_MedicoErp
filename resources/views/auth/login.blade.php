...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
         ...
         <!--   <p class="card-description text-center">{{ __('Or Sign in with ') }} <strong>admin@material.com</strong> {{ __(' and the password ') }}<strong>secret</strong> </p> -->
            ...
            <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password" id="password" class="form-control" placeholder="{{ __('Password...') }}" value="" required> <!--{{ !$errors->has('password') ? "secret" : "" }}--->
              </div>
    ...
    <!---- remember me testing       <div class="form-check mr-auto ml-3 mt-3">
